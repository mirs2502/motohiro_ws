...
: ${AMENT_CURRENT_PREFIX:="/home/yzksy/mirs2502_standard/install/cone_detector"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cone_detector/environment/library_path.sh"
