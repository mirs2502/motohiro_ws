...
static const _Params_Request_type_support_symbol_names_t _Params_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mirs_msgs, srv, Params_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mirs_msgs, srv, Params_Request)),
  }
};
...
{
  return &::mirs_msgs::srv::rosidl_typesupport_cpp::Params_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mirs_msgs, srv, Params_Request)() {
  return get_message_type_support_handle<mirs_msgs::srv::Params_Request>();
}
...
static const _Params_Response_type_support_symbol_names_t _Params_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mirs_msgs, srv, Params_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mirs_msgs, srv, Params_Response)),
  }
};
...
{
  return &::mirs_msgs::srv::rosidl_typesupport_cpp::Params_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mirs_msgs, srv, Params_Response)() {
  return get_message_type_support_handle<mirs_msgs::srv::Params_Response>();
}
...
static const _Params_type_support_symbol_names_t _Params_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mirs_msgs, srv, Params)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mirs_msgs, srv, Params)),
  }
};
...
{
  return &::mirs_msgs::srv::rosidl_typesupport_cpp::Params_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, mirs_msgs, srv, Params)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<mirs_msgs::srv::Params>();
}
